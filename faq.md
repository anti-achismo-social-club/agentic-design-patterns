...
## What are some of the key agentic patterns discussed?
...
## Why is "planning" an important pattern?
...
## What is the difference between a "tool" and a "skill" for an agent?
...
## How does the "Reflection" pattern improve an agent's performance?
...
## What is the core idea of the Reflection pattern?
...
## Why is simple "prompt chaining" not enough for high-quality output?
...
## What are the two main types of reflection mentioned in this chapter?
...
## How does reflection help in reducing "hallucinations"?
...
## What is the Planning pattern in the context of AI agents?
...
## Why is planning necessary for complex tasks?
...
## What is a common way to implement the Planning pattern?
...
## How does the agent handle errors or changes during execution?
...
## What does the "Tool Use" pattern entail?
...
## What is the "ReAct" (Reason and Act) framework mentioned in this context?
...
## What are some challenges in implementing tool use?
...
## Why is HITL important for agentic systems?
...
## At what points in a workflow should you include a human?
...
## What is a common architecture for multi-agent systems?
